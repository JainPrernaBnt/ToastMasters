        ...
        return try {
            ...
            if (document.exists()) {
                ...
                val item = AgendaItem(
                    ...
                    speakerPathwaysTrack = data["speakerPathwaysTrack"] as? String ?: "",
                    speakerLevel = (data["speakerLevel"] as? Number)?.toInt() ?: 0,
                    speakerProjectNumber = data["speakerProjectNumber"] as? String ?: "",
    ...
    override suspend fun saveAgendaItem(
        ...
        return try {
            ...
            val itemData = hashMapOf(
                ...
                "speakerPathwaysTrack" to (item.speakerPathwaysTrack ?: ""),
                "speakerLevel" to item.speakerLevel,
                "speakerProjectNumber" to (item.speakerProjectNumber ?: ""),
